...
public class ControllerEssBatterytestingImplTest {
	...
	public void testGetAcPower() throws OpenemsException, Exception {
	    ...
	    assertEquals(1000,
	            ControllerEssBatterytestingImpl.getAcPower(hybridEss, battery, HybridEssMode.TARGET_AC, 5000));

	    assertEquals(5000, //Integer.valueOf(5000)
	            ControllerEssBatterytestingImpl.getAcPower(hybridEss, battery, HybridEssMode.TARGET_DC, 5000));
	}
}

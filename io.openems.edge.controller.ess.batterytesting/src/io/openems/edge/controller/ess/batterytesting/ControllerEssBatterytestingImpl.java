...
public class ControllerEssBatterytestingImpl extends AbstractOpenemsComponent
		implements ControllerEssBatterytesting, Controller, OpenemsComponent, TimedataProvider {

	private final CalculateActiveTime calculateCumulatedActiveTime = new CalculateActiveTime(this,
			ControllerEssBatterytesting.ChannelId.CUMULATED_ACTIVE_TIME);
	...
	public ControllerEssBatterytestingImpl() {
		super(//
				...
				ControllerEssBatterytesting.ChannelId.values() //
		);
	}
